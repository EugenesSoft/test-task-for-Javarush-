...
<table frame="border" bgcolor="#A0CB83">
    <tr>
        <td>ID</td><td>NAME</td><td>AGE</td><td>IS ADMIN</td><td>DATE CREATED</td><td></td>
    </tr>
    <c:forEach items="${users}" var="user">
        <tr>
            ...
            <td>${user.age}</td>
            <td>${user.isAdmin}</td>
            <td><joda:format value="${user.dateCreated}" style="MM"/></td>
            <td align="center"><form:form method="get" action="/delete-${user.id}-user">
